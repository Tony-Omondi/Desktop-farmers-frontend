  ...
  return (
    <div className="bg-gray-50 min-h-screen flex flex-col" style={{ fontFamily: '"Plus Jakarta Sans", "Noto Sans", sans-serif' }}>
      ...
      {showCartNotification && (
        <div className="fixed top-4 right-4 z-50 bg-white p-4 rounded-lg shadow-lg border border-emerald-200 flex items-center animate-pulse">
      ...
      <div className="md:hidden fixed top-4 right-4 z-50">
        <a
          ...
          className="relative p-2 bg-white rounded-lg shadow-md flex items-center justify-center"
        >
          <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="flex flex-1">
        {/* Sidebar */}
        <aside
          className={`fixed md:relative inset-y-0 left-0 w-64 bg-white shadow-lg z-40 transform ${isOpen ? 'translate-x-0' : '-translate-x-full'} md:translate-x-0 transition-transform duration-300 ease-in-out flex flex-col`}
        >
          <div className="flex flex-col h-full p-6">
            ...
            <div className="flex items-center mb-8 p-3 rounded-lg hover:bg-gray-50 transition-colors cursor-pointer">
              ...
              <div>
                ...
                <a href="/frontend_ai/profile" className="text-xs text-gray-500 hover:text-emerald-600">View profile</a>
              </div>
            </div>
        ...
        <main className="flex-1 md:ml-64">
          <div className="max-w-6xl mx-auto p-4 md:p-8">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4">
              <h1 className="text-2xl font-bold text-gray-800">Welcome back, {user?.full_name?.split(' ')[0] || 'User'}!</h1>
              <div className="flex flex-col sm:flex-row gap-3">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <a
                    href="/frontend_ai/cart"
                    className="relative p-2 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 flex items-center justify-center"
                  >
                    <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z"></path>
                    </svg>
            ...
            <div className="bg-white rounded-xl shadow-sm overflow-hidden mb-8">
              <div className="p-6 border-b border-gray-200 flex flex-col sm:flex-row sm:items-center justify-between">
                <h2 className="text-xl font-bold text-gray-800 mb-2 sm:mb-0">Products</h2>
                ...
                {filteredProducts.length === 0 ? (
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                    {filteredProducts.map((product) => (
                      <div key={product.id} className="bg-white border border-gray-200 rounded-lg overflow-hidden hover:shadow-md transition-all duration-300">
                        <div className="relative">
                          <img
                            src={
                          ...
                          <button
                            ...
                            className="absolute top-3 right-3 p-2 bg-white rounded-full shadow-md hover:bg-emerald-50 hover:text-emerald-600 transition-colors"
                        ...
                        <div className="p-4">
                          ...
                          <div className="flex items-center justify-between">
                            <p className="text-emerald-600 font-medium text-lg">KSh {formatPrice(product.price)}</p>
                            <button
                              onClick={() => addToCart(product)}
